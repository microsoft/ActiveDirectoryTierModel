...
> ⚠️ **v1.2.1 measured:** UI and reliability fixes added ~600 production lines across 8 files; overall dipped 90.92% → 88.68% (all still above the 80% CI gate on the module scope). `Audit-TierModel.ps1` dropped to 73.1% (new fail-fast/alignment code paths that need live-AD or PS<7 to exercise — documented hard limits).
...
| **TOTAL (CI-scoped 82-file module population)** | 14,651 | 2,113 | 16,719 | **87.63%** |
